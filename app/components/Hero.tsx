...
export default function Hero({ onStartLearning }: HeroProps) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between min-h-[90vh] overflow-hidden px-6 py-12 md:py-20 bg-gradient-to-b from-theme-primary-light/40 via-white/50 to-theme-primary-light/20 text-slate-800">
      ...
      <div className="relative z-20 max-w-5xl w-full flex flex-col items-center text-center my-auto gap-8">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight">
          Explore the Wonders of the Ocean with <span className="bg-gradient-to-r from-theme-primary to-theme-secondary bg-clip-text text-transparent">AquaQuest</span>
        </h1>
